...
for i = 1:0.1:5 % Begin with uniform atom spacing and then spacing increases
AtomSpacing = 0.5430710e-9*i;
end
...
X0 = AtomSpacing*[-0.8 -0.4 0 0.4 0.6 0.8];
Y0 = AtomSpacing*[0 0 -1.2 0 0];
